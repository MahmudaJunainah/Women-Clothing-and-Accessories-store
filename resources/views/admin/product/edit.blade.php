  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        ...
        <h6>If product is instock then write 1 in stock, otherwise write 0 in stock</h6>
      ...
      <div class="x_content">
        ...
        <form id="demo-form2" action="{{route('product.update',$product->id)}}" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="enum" name="status" value="{{$product->status}}" class="form-control col-md-7 col-xs-12" required="">
