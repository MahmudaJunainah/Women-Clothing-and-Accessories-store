    ...
    <div class="container-fluid">
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">Women's</span>Store</h1>
                    </a>
                    <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{route('rating')}}" class="nav-item nav-link">Rating and review</a>
                            <!--<a href="{{route('productView')}}" class="nav-item nav-link">Shop Detail</a>-->
                            <div class="nav-item dropdown">
                        ...
                        @if(Auth::user())
                            <div class="navbar-nav ml-auto py-0">
                                ...
                                <a href="{{route('user.dashboard')}}" class="nav-item nav-link">Profile</a>
                            </div>
                        @else
                        <div class="navbar-nav ml-auto py-0">
